...
VALUES
    ...
    ('CM1025','Fundamentals of Computer Science', true),
    ('CM1030','How Computers Work', true),
    ('CM1035','Algorithms and Data Structures I', true),
    ...
    ('CM2035','Algorithms and Data Structures II', true),
    ('CM2040','Databases, Networks and the Web', true),
    ('CM3005','Data Science', false),
    ('CM3010','Databases and Advanced Data Techniques', false),
    ('CM3015','Machine Learning and Neural Networks', false),
    ...
    ('CM3040','Physical Computing and Internet of Things', false),
